package estudos.br.com.tekqa.WorkshopMongo.config;
...
public class Instantiation implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    SimpleDateFormat sdf =
        new SimpleDateFormat("dd/MM/yyyy"); // Configurando o formato da data a ser usado.
    sdf.setTimeZone(TimeZone.getTimeZone("GMT")); // configurando o Fuso horário adotado.
